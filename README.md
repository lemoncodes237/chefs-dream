...
- Ice Cream Machine: Created from a Daylight Sensor. You must add snowballs and milk to the ice cream machine before you can make ice cream. There is no ice cream cookbook, but all the recipes can be found on the wiki page [here](https://github.com/lemoncodes237/chefs-dream/wiki/Ice-Cream-Machine).
