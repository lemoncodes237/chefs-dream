...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{Tags:["strawberry"]}}}}] run return run function chefsdream:ingredients/mixer/add_strawberry
