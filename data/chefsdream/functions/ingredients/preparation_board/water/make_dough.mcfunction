...
data modify entity @e[type=item_display,tag=preparation_board_display,distance=..1,sort=nearest,limit=1] item set value {id:"minecraft:snowball",Count:1,tag:{Tags:["dough"],CustomModelData:2300003,display:{Name:'[{"text":"Dough","italic":false}]'}}}
