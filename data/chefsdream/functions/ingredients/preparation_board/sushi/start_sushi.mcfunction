summon block_display ~ ~0.1 ~ {transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],scale:[0.8f,0.05f,0.8f],translation:[0f,0f,0f]},block_state:{Name:"minecraft:black_concrete_powder"},Tags:["nori","chefsdream"]}
