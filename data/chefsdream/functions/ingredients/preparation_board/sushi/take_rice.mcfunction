...
give @s cookie[custom_data={chefsdreamfood:1,Tags:["steamed_rice"]},food={nutrition:3,saturation_modifier:6,can_always_eat:1},custom_name='[{"text":"Steamed Rice","italic":false}]',custom_model_data=2370053]