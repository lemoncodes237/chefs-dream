...
tag @e[type=interaction,distance=..1,limit=1,sort=nearest,tag=barrel] add sweet_berry_yogurt
...
title @s actionbar ["","Barrel Sealed. Result: ",{"score":{"name":"@e[type=interaction,distance=..1,limit=1,sort=nearest,tag=barrel]","objective":"var"}}," sweet berry yogurt."]
