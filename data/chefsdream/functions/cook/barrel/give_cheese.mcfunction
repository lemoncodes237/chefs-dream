...
give @s cookie[custom_data={chefsdreamfood:1,Tags:["cheese"]},food={nutrition:2,saturation_modifier:4,can_always_eat:1},custom_name='[{"text":"Cheese","italic":false}]',custom_model_data=2370046]
