...
give @s cookie[custom_data={Tags:["yogurt"]},custom_name='[{"text":"Glow Berry Yogurt","italic":false}]',custom_model_data=2370124,food={nutrition:6,saturation:12,can_always_eat:1,effects:[{effect:{id:"minecraft:glowing",duration:200,amplifier:0,show_particles:true,show_icon:true}}]}]
