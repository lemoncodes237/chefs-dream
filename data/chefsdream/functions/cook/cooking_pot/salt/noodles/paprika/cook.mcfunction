...
give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:8,saturation_modifier:16,can_always_eat:1},custom_name='[{"text":"Spicy Ramen","italic":false}]',custom_model_data=2370025]
