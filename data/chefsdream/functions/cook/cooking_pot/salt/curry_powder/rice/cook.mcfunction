...
give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:6,saturation_modifier:12,can_always_eat:1},custom_name='[{"text":"Curry and Rice","italic":false}]',custom_model_data=2370008]
