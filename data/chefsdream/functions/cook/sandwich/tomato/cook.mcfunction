...
execute if score @e[type=interaction,distance=..1,limit=1,sort=nearest,tag=sandwich] ing_lettuce matches 1.. run return run function chefsdream:cook/sandwich/tomato/lettuce/cook
