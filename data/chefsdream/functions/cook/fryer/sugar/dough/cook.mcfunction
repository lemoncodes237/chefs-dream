...
execute if score @e[type=interaction,distance=..1,limit=1,sort=nearest,tag=fryer] ing_sugar matches 1 run give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:6,saturation_modifier:12,can_always_eat:1},custom_name='[{"text":"Bagel","italic":false}]',custom_model_data=2370040]

# Correct recipe - Glazed Donut
execute if score @e[type=interaction,distance=..1,limit=1,sort=nearest,tag=fryer] ing_sugar matches 2.. run give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:7,saturation_modifier:14,can_always_eat:1},custom_name='[{"text":"Glazed Donut","italic":false}]',custom_model_data=2370039]
