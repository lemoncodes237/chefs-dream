...
give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:16,saturation_modifier:32,can_always_eat:1},custom_name='[{"text":"Hotdog","italic":false}]',custom_model_data=2370063]
