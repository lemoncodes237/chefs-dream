...
execute if score @e[type=interaction,distance=..1,limit=1,sort=nearest,tag=sushi] ing_paprika matches 1.. run return run function chefsdream:cook/sushi/salmon/lettuce/paprika/cook
