...
give @s cookie[custom_data={chefsdreamfood:1,icecream:1},food={nutrition:5,saturation:10,can_always_eat:1},custom_name='[{"text":"Coffee Ice Cream","italic":false}]',custom_model_data=2370091]
