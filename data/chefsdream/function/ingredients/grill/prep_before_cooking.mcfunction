...
tag @e[type=interaction,distance=..1,tag=grill,sort=nearest,limit=1] add in_cooking
data remove entity @e[type=interaction,distance=..1,tag=grill,limit=1] interaction
execute as @e[type=interaction,distance=..1,tag=in_cooking,sort=nearest,limit=1] run function chefsdream:cook/grill/start_cooking