...
execute if entity @s[nbt={SelectedItem:{id:"minecraft:beef"}}] run return run function chefsdream:ingredients/oven/add_beef
...
execute if entity @s[nbt={SelectedItem:{id:"minecraft:bread"}}] run return run function chefsdream:ingredients/oven/add_bread
...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{Tags:["mustard"]}}}}] run return run function chefsdream:ingredients/oven/add_mustard
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{Tags:["garlic"]}}}}] run return run function chefsdream:ingredients/oven/add_garlic
