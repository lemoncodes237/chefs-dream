...
execute if items entity @s weapon.mainhand cookie[minecraft:custom_data~{"bread_slice":1}] run function chefsdream:ingredients/preparation_board/sandwich/start_sandwich
execute if items entity @s weapon.mainhand cookie[minecraft:custom_data~{"tortilla":1}] run function chefsdream:ingredients/preparation_board/taco/start_taco
