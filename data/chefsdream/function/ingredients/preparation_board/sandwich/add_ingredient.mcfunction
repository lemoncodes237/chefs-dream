...
execute if score @e[type=interaction,tag=preparation_board,distance=..1,tag=sandwich,limit=1,sort=nearest] ingredients matches 7 run summon item_display ~ ~-0.0625 ~ {Rotation:[0f,90f],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f]},Tags:["req","sandwich_display","chefsdream"]}
execute if score @e[type=interaction,tag=preparation_board,distance=..1,tag=sandwich,limit=1,sort=nearest] ingredients matches 8 run summon item_display ~ ~ ~ {Rotation:[0f,90f],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f]},Tags:["req","sandwich_display","chefsdream"]}
