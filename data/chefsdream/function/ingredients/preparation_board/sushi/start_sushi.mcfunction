...
tag @e[type=interaction,tag=preparation_board,distance=..1,limit=1,sort=nearest] add used
tag @e[type=interaction,tag=preparation_board,distance=..1,limit=1,sort=nearest] add sushi
scoreboard players add @e[type=interaction,tag=preparation_board,distance=..1,limit=1,sort=nearest] ingredients 1
