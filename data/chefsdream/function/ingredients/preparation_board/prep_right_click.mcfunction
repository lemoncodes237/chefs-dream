...
execute if items entity @s weapon.mainhand cookie[minecraft:custom_data~{Tags:["lettuce"]}] run return run function chefsdream:ingredients/preparation_board/lettuce/right_click
...
execute if items entity @s weapon.mainhand magenta_dye[minecraft:custom_data~{Tags:["salt"]}] run return run function chefsdream:ingredients/preparation_board/salt/right_click