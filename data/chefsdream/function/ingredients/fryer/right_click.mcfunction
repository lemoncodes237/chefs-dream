...
execute if entity @s[nbt={SelectedItem:{id:"minecraft:porkchop"}}] run return run function chefsdream:ingredients/fryer/add_porkchop
...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{Tags:["yogurt"]}}}}] run return run function chefsdream:ingredients/fryer/add_yogurt
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{Tags:["beans"]}}}}] run return run function chefsdream:ingredients/fryer/add_beans
...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{Tags:["dragon_meat"]}}}}] run return run function chefsdream:ingredients/fryer/add_dragon