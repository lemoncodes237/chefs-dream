...
execute if items entity @s weapon.mainhand cookie[minecraft:custom_data~{waffle_cone:1}] run return run function chefsdream:cook/ice_cream_machine/make_ice_cream
