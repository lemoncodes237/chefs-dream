...
give @s cookie[custom_data={Tags:["yogurt"]},custom_name='[{"text":"Glow Berry Yogurt","italic":false}]',item_model="chefsdream:glow_berry_yogurt",food={nutrition:6,saturation:12,can_always_eat:1},consumable={on_consume_effects:[{type:"apply_effects",effects:[{id:"minecraft:glowing",duration:200,amplifier:0,show_particles:true,show_icon:true}]}]}]
