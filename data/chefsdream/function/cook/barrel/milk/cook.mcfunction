...
execute if score @e[type=interaction,distance=..1,limit=1,sort=nearest,tag=barrel] ing_orange matches 1.. run return run function chefsdream:cook/barrel/milk/orange/cook
