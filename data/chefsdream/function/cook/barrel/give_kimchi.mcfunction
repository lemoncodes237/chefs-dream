...
give @s cookie[custom_data={chefsdreamfood:1,Tags:["kimchi"]},food={nutrition:6,saturation:12,can_always_eat:1},custom_name='[{"text":"Kimchi","italic":false}]',custom_model_data=2370014]
