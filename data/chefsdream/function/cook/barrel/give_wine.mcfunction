...
give @s potion[minecraft:custom_model_data=2337035,minecraft:potion_contents={custom_color:16777215,custom_effects:[{id:"minecraft:saturation",duration:1,amplifier:1},{id:"minecraft:nausea",duration:200,amplifier:1}]},custom_name='[{"text":"Wine","italic":false}]']
