...
give @s potion[max_stack_size=64,minecraft:item_model="chefsdream:wine",minecraft:potion_contents={custom_color:16777215,custom_effects:[{id:"minecraft:saturation",duration:1,amplifier:1},{id:"minecraft:nausea",duration:200,amplifier:1}]},custom_name='[{"text":"Wine","italic":false}]']
