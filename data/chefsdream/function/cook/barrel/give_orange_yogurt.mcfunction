...
give @s cookie[custom_data={Tags:["yogurt"]},custom_name='[{"text":"Orange Yogurt","italic":false}]',custom_model_data=2370122,food={nutrition:6,saturation:12,can_always_eat:1}]
