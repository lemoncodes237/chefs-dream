...
give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:2,saturation:4,can_always_eat:1},custom_name='[{"text":"Vanilla Macaron","italic":false}]',item_model="chefsdream:vanilla_macaron"] 3
