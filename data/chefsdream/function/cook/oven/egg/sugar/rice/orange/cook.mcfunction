...
give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:3,saturation:6,can_always_eat:1},custom_name='[{"text":"Orange Macaron","italic":false}]',item_model="chefsdream:orange_macaron"] 3
