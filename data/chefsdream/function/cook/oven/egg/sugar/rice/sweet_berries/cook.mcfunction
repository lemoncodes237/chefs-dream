...
give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:3,saturation:6,can_always_eat:1},custom_name='[{"text":"Sweet Berry Macaron","italic":false}]',item_model="chefsdream:sweet_berry_macaron"] 3
