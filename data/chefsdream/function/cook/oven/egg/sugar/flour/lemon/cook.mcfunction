...
execute if score @e[type=interaction,distance=..1,limit=1,sort=nearest,tag=oven] ing_banana matches 1.. run return run function chefsdream:cook/oven/egg/sugar/flour/lemon/banana/cook
