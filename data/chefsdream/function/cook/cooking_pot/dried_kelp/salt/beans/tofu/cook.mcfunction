...
# Correct recipe - Miso Soup
give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:5,saturation:10,can_always_eat:1},custom_name='[{"text":"Miso Soup","italic":false}]',item_model="chefsdream:miso_soup"]
