...
give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:5,saturation:10,can_always_eat:1},custom_name='[{"text":"Miso Soup","italic":false}]',custom_model_data=2370172]
