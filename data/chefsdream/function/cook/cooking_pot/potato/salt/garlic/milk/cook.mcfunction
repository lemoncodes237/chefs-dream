...
give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:10,saturation:20,can_always_eat:1},custom_name='[{"text":"Mashed Potatoes","italic":false}]',item_model="chefsdream:mashed_potatoes"]
