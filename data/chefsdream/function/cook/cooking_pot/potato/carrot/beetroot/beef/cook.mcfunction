...
give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:18,saturation:36,can_always_eat:1},custom_name='[{"text":"Beef Stew","italic":false}]',item_model="chefsdream:beef_stew"]
