...
give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:12,saturation:24,can_always_eat:1},custom_name='[{"text":"Shio Ramen","italic":false}]',custom_model_data=2370173]
