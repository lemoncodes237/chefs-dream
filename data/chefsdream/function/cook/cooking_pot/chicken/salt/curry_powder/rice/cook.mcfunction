...
# Correct recipe - Chicken Curry
give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:6,saturation:12,can_always_eat:1},custom_name='[{"text":"Chicken Curry","italic":false}]',item_model="chefsdream:chicken_curry"]
