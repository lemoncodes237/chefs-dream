...
give @s cookie[custom_data={chefsdream:1},food={nutrition:16,saturation:32,can_always_eat:1},custom_name='[{"text":"Dumplings","italic":false}]',custom_model_data=2370149]
