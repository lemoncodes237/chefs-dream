...
give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:20,saturation:40,can_always_eat:1,effects:[{effect:{id:"minecraft:saturation",duration:1200,amplifier:2,show_particles:false,show_icon:true}}]},custom_name='[{"text":"Palak Paneer","italic":false}]',custom_model_data=2370180]
