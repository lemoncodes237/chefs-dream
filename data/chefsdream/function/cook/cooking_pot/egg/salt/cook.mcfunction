...
give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:4,saturation:8,can_always_eat:1},custom_name='[{"text":"Steamed Eggs","italic":false}]',custom_model_data=2370027]
