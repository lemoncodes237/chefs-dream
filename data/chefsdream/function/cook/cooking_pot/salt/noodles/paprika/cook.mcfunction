...
give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:8,saturation:16,can_always_eat:1},custom_name='[{"text":"Spicy Ramen","italic":false}]',item_model="chefsdream:spicy_ramen"]
