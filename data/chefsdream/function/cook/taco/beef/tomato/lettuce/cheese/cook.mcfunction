...
give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:18,saturation:36,can_always_eat:1},custom_name='[{"text":"Beef Taco","italic":false}]',custom_model_data=2370197]
