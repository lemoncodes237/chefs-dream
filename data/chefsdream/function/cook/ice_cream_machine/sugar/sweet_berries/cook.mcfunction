...
execute unless items entity @s weapon.mainhand cookie[minecraft:custom_data~{Tags:["waffle_cone"]}] run give @s cookie[custom_data={chefsdreamfood:1,icecream:1},food={nutrition:6,saturation:12,can_always_eat:1},custom_name='[{"text":"Sweet Berry Ice Cream","italic":false}]',item_model="chefsdream:sweet_berry_ice_cream"]
execute if items entity @s weapon.mainhand cookie[minecraft:custom_data~{Tags:["waffle_cone"]}] run give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:8,saturation:16,can_always_eat:1},custom_name='[{"text":"Sweet Berry Ice Cream","italic":false}]',item_model="chefsdream:sweet_berry_ice_cream_cone"]
