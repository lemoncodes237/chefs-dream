...
execute if score @e[type=interaction,distance=..1,limit=1,sort=nearest,tag=ice_cream_machine] ing_sugar matches 2.. run give @s cookie[custom_data={chefsdreamfood:1,icecream:1,Tags:["ice_cream"]},food={nutrition:6,saturation:12,can_always_eat:1},custom_name='[{"text":"Vanilla Ice Cream","italic":false}]',custom_model_data=2370081]
