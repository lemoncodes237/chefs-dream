...
give @s cookie[custom_data={chefsdreamfood:1,icecream:1},food={nutrition:7,saturation:14,can_always_eat:1},custom_name='[{"text":"Chocolate Ice Cream","italic":false}]',custom_model_data=2370082]
