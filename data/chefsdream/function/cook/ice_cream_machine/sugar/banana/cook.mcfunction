...
execute unless items entity @s weapon.mainhand cookie[minecraft:custom_data~{waffle_cone:1}] run function chefsdream:give/banana_ice_cream
execute if items entity @s weapon.mainhand cookie[minecraft:custom_data~{waffle_cone:1}] run function chefsdream:give/banana_ice_cream_cone
