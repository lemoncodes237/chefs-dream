...
execute unless items entity @s weapon.mainhand cookie[minecraft:custom_data~{Tags:["waffle_cone"]}] run give @s cookie[custom_data={chefsdreamfood:1,icecream:1},food={nutrition:6,saturation:12,can_always_eat:1,effects:[{effect:{id:"minecraft:glowing",duration:200,amplifier:0,show_particles:true,show_icon:true}}]},custom_name='[{"text":"Glow Berry Ice Cream","italic":false}]',custom_model_data=2370084]
execute if items entity @s weapon.mainhand cookie[minecraft:custom_data~{Tags:["waffle_cone"]}] run give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:8,saturation:16,can_always_eat:1,effects:[{effect:{id:"minecraft:glowing",duration:200,amplifier:0,show_particles:true,show_icon:true}}]},custom_name='[{"text":"Glow Berry Ice Cream","italic":false}]',custom_model_data=2370223]
