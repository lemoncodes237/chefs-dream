...
give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:20,saturation:40,can_always_eat:1},custom_name='[{"text":"Philly Roll","italic":false}]',item_model="chefsdream:philly_roll"]
