...
give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:15,saturation:30,can_always_eat:1},custom_name='[{"text":"Tropical Cream Roll","italic":false}]',item_model="chefsdream:tropical_cream_roll"]
