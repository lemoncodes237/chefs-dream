...
# Correct recipe - Tea
give @s potion[max_stack_size=64,minecraft:item_model="chefsdream:tea",minecraft:potion_contents={custom_color:16777215,custom_effects:[{id:"minecraft:saturation",duration:1,amplifier:1},{id:"minecraft:resistance",duration:200,amplifier:0}]},custom_name='[{"text":"Tea","italic":false}]']
