...
execute if score @e[type=interaction,tag=mixer,sort=nearest,distance=..1,limit=1] ing_salt matches 1.. run return run function chefsdream:cook/mixer/sugar/salt/cook
...
execute if score @e[type=interaction,tag=mixer,sort=nearest,distance=..1,limit=1] ing_rice matches 1.. run return run function chefsdream:cook/mixer/sugar/rice/cook
...
execute if score @e[type=interaction,tag=mixer,sort=nearest,distance=..1,limit=1] ing_banana matches 1.. run return run function chefsdream:cook/mixer/sugar/banana/cook
...
execute if score @e[type=interaction,tag=mixer,sort=nearest,distance=..1,limit=1] ing_yogurt matches 1.. run return run function chefsdream:cook/mixer/sugar/yogurt/cook
