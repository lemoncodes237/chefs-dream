...
give @s potion[minecraft:custom_model_data=2337015,minecraft:potion_contents={custom_color:16777215,custom_effects:[{id:"minecraft:saturation",duration:1,amplifier:7},{id:"minecraft:strength",duration:200,amplifier:0}]},custom_name='[{"text":"Boba Milk Tea","italic":false}]']
