...
give @s potion[max_stack_size=64,minecraft:custom_model_data=2337019,minecraft:potion_contents={custom_color:16777215,custom_effects:[{id:"minecraft:saturation",duration:1,amplifier:9},{id:"minecraft:speed",duration:200,amplifier:0}]},custom_name='[{"text":"Lemon Bubble Tea","italic":false}]']
