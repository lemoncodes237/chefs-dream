...
# Correct recipe - Lemon Bubble Tea
give @s potion[max_stack_size=64,minecraft:item_model="chefsdream:lemon_bubble_tea",minecraft:potion_contents={custom_color:16777215,custom_effects:[{id:"minecraft:saturation",duration:1,amplifier:9},{id:"minecraft:speed",duration:200,amplifier:0}]},custom_name='[{"text":"Lemon Bubble Tea","italic":false}]']
