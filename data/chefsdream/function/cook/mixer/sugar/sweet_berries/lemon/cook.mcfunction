...
give @s potion[max_stack_size=64,minecraft:item_model="chefsdream:sweet_berry_lemonade",minecraft:potion_contents={custom_color:16777215,custom_effects:[{id:"minecraft:saturation",duration:1,amplifier:5},{id:"minecraft:speed",duration:200,amplifier:0},{id:"minecraft:absorption",duration:200,amplifier:0}]},custom_name='[{"text":"Sweet Berry Lemonade","italic":false}]']
