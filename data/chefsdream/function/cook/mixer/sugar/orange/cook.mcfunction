...
give @s potion[minecraft:custom_model_data=2337002,minecraft:potion_contents={custom_color:16777215,custom_effects:[{id:"minecraft:saturation",duration:1,amplifier:3},{id:"minecraft:night_vision",duration:200,amplifier:0}]},custom_name='[{"text":"Orange Juice","italic":false}]']
