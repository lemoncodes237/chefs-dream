...
# Correct recipe - Cappuccino
give @s potion[max_stack_size=64,minecraft:item_model="chefsdream:cappuccino",minecraft:potion_contents={custom_color:16777215,custom_effects:[{id:"minecraft:saturation",duration:1,amplifier:2},{id:"minecraft:night_vision",duration:1200,amplifier:0}]},custom_name='[{"text":"Cappuccino","italic":false}]']
