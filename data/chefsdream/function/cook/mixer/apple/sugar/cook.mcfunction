...
give @s potion[max_stack_size=64,minecraft:item_model="chefsdream:apple_juice",minecraft:potion_contents={custom_color:16777215,custom_effects:[{id:"minecraft:saturation",duration:1,amplifier:3},{id:"minecraft:jump_boost",duration:200,amplifier:0}]},custom_name='[{"text":"Apple Juice","italic":false}]']
