...
give @s potion[max_stack_size=64,minecraft:item_model="chefsdream:vanilla_milkshake",minecraft:potion_contents={custom_color:16777215,custom_effects:[{id:"minecraft:saturation",duration:1,amplifier:7},{id:"minecraft:speed",duration:200,amplifier:1}]},custom_name='[{"text":"Vanilla Milkshake","italic":false}]']
