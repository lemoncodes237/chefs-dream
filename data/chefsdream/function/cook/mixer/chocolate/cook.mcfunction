...
give @s potion[max_stack_size=64,minecraft:item_model="chefsdream:hot_chocolate",minecraft:potion_contents={custom_color:16777215,custom_effects:[{id:"minecraft:saturation",duration:1,amplifier:3},{id:"minecraft:fire_resistance",duration:200,amplifier:0}]},custom_name='[{"text":"Hot Chocolate","italic":false}]']
