...
give @s potion[max_stack_size=64,minecraft:custom_model_data=2337010,minecraft:potion_contents={custom_color:16777215,custom_effects:[{id:"minecraft:saturation",duration:1,amplifier:3},{id:"minecraft:night_vision",duration:1200,amplifier:0}]},custom_name='[{"text":"Mocha","italic":false}]']
