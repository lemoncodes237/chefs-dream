...
give @s potion[max_stack_size=64,minecraft:item_model="chefsdream:glow_berry_delight",minecraft:potion_contents={custom_color:16777215,custom_effects:[{id:"minecraft:saturation",duration:1,amplifier:7},{id:"minecraft:glowing",duration:200,amplifier:0},{id:"minecraft:absorption",duration:200,amplifier:1}]},custom_name='[{"text":"Glow Berry Delight","italic":false}]']
