...
give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:20,saturation:40,can_always_eat:1},custom_name='[{"text":"Mushroom Burger","italic":false}]',custom_model_data=2370130]
