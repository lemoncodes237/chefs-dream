...
give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:17,saturation:34,can_always_eat:1},custom_name='[{"text":"Grilled Pork Banh Mi","italic":false}]',custom_model_data=2370187]
