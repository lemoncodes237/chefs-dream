...
give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:11,saturation:22,can_always_eat:1},custom_name='[{"text":"Hamburger","italic":false}]',item_model="chefsdream:normal_hamburger"]
