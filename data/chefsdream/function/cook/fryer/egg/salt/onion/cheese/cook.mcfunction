...
give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:14,saturation:28,can_always_eat:1},custom_name='[{"text":"Onion and Cheese Omelette","italic":false}]',item_model="chefsdream:onion_and_cheese_omelette"]
