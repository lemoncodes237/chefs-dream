...
give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:16,saturation:32,can_always_eat:1},custom_name='[{"text":"Vegetable Omelette","italic":false}]',item_model="chefsdream:vegetable_omelette"]
