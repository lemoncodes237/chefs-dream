...
give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:9,saturation:18,can_always_eat:1},custom_name='[{"text":"Pancake","italic":false}]',item_model="chefsdream:pancake"]
