...
give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:8,saturation:16,can_always_eat:1},custom_name='[{"text":"Cream Donut","italic":false}]',custom_model_data=2370237]
