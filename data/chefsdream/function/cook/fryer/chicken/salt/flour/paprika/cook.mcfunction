...
give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:14,saturation:28,can_always_eat:1},custom_name='[{"text":"Buffalo Wings","italic":false}]',item_model="chefsdream:buffalo_wings"]
