...
give @s cookie[custom_data={chefsdreamfood:1},food={nutrition:14,saturation:28,can_always_eat:1},custom_name='[{"text":"Mushroom Omelette","italic":false}]',custom_model_data=2370142]
