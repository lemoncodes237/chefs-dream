...
give @s cookie[custom_data={chefsdreamfood:1,Tags:["tortilla"]},food={nutrition:1,saturation:2,can_always_eat:1b},custom_name='[{"text":"Tortilla","italic":false}]',item_model="chefsdream:tortilla"] 5
