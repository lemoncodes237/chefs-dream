...
summon interaction ~0.5 ~ ~0.5 {width:1.0f,height:0.5f,response:1b,Tags:["chefsdream_placedcake","normalcake","delete"]}
summon item_display ~0.5 ~0.5 ~0.5 {Tags:["delete","chefsdreamcakedisplay"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]},item:{id:"minecraft:command_block",count:1,components:{"minecraft:custom_model_data":2323001}}}
