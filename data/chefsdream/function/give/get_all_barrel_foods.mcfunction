give @s cookie[custom_data={chefsdream:1,Tags:["chocolate"]},food={nutrition:3,saturation:6,can_always_eat:1},custom_name='[{"text":"Chocolate","italic":false}]',item_model="chefsdream:chocolate"]
give @s cookie[custom_data={chefsdream:1,Tags:["kimchi"]},food={nutrition:6,saturation:12,can_always_eat:1},custom_name='[{"text":"Kimchi","italic":false}]',item_model="chefsdream:kimchi"]
give @s cookie[custom_data={chefsdream:1,Tags:["cheese"]},food={nutrition:2,saturation:4,can_always_eat:1},custom_name='[{"text":"Cheese","italic":false}]',item_model="chefsdream:cheese"]
